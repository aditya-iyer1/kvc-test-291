...
class LLMNeedleHaystackTester:
    ...
    def __init__(self,
        ...
        if(self.model_provider in ["LLaMA3", "Mistral"]):
            ...
            if self.method in ["pyramidkv", "snapkv","streamingllm","streamingllmsliding","h2o","cam"]:
                ...
                if self.method.lower() == "pyramidkv":
                    window_sizes = 8
                elif self.method.lower() in ["snapkv","streamingllm","streamingllmsliding","h2o","cam"]:
                    window_sizes = 32
...
if __name__ == "__main__":
    ...
    parser.add_argument('--method', type=str, default="full", choices=['full', 'pyramidkv', 'snapkv', 'streamingllm', 'streamingllmsliding', 'h2o', 'cam'])
